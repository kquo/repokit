...
2. **Overlay templates** — `overlays/code/files/` and `overlays/doc/files/` (`.tmpl` copies with placeholders)
...
- `overlays/code/files/cmd/build/main.go.tmpl`
...
3. Apply the same fix to overlay templates (`overlays/`)
...
|--------|--------------|--------------|
| `internal/buildtool/` | `overlays/code/files/cmd/build/main.go.tmpl` | `examples/code/cmd/build/main.go` |
| `internal/reltool/` | `overlays/code/files/cmd/rel/main.go.tmpl`, `overlays/doc/files/cmd/rel/main.go.tmpl` | `examples/code/cmd/rel/main.go`, `examples/doc/cmd/rel/main.go` |
| `internal/color/` | `overlays/code/files/cmd/build/color.go.tmpl`, `overlays/code/files/cmd/rel/color.go.tmpl` | `examples/code/cmd/build/color.go`, `examples/code/cmd/rel/color.go` |
| `build.sh` | `overlays/code/files/build.sh.tmpl` | `examples/code/build.sh` |
