...
This repo uses an acceptance-criteria-first workflow when scope needs explicit review.
...
2. draft an acceptance-criteria doc from `docs/ac-template.md` when scope needs explicit constraints; save as `docs/acN-short-slug.md`
